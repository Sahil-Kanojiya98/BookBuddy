...
public class JwtTokenAuthenticationFilter extends OncePerRequestFilter {
	...
	protected Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		UserPrincipal principal = new UserPrincipal(payload.getUserId(), payload.getUsername(), payload.getEmail(),
	...
	protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
		...
		if (authResult.getPrincipal() instanceof UserPrincipal userPrincipal) {
			request.setAttribute(USER_ID_ATTRIBUTE, userPrincipal.getId());
		}
